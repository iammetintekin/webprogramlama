...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="input-group mb-2 mr-sm-2">
        <div class="input-group-text bg-info ">
               <asp:LinkButton CssClass="btn btn-square text-white" Text='<i class="fa fa-search"></i> ARA' ID="siparisKontrol" OnClick="siparisKontrol_Click" runat="server" />
        </div>
        ...
        <div class="input-group-text bg-danger text-white">
            <a href="WebServis.aspx"><span class='fa fa-times'></span></a>
